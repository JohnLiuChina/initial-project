...
@Slf4j
@Service
@DataSource(dataSource = "http://b.etouch.cn/weather_mini?city=")
public class ServiceB implements WeatherService {
    ...
    public Weather getWeather(String city) throws WeatherException {
        ...
        if (!resp.getStatusCode().is2xxSuccessful()) {
            ...
            throw new WeatherException("Get weather from datasource B error!", resp.getStatusCodeValue());
        }
        return resp.getBody();
    }
}
